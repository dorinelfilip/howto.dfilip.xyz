...
## What about updating OpenWRT after this?

Updates should work as usual. However, before flashing a new firmware (using **System -> Backup / Flash Firmware**) please make sure the following files are specified to be included in the backup (check the **Configuration** tab of the previously mentioned page in Luci):

```
# /etc/config/80211x-CA.pem
/etc/config/wpadot1x.conf
